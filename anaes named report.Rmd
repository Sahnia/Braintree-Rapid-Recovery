...
named_anaes_facet + labs(title= "Fig 4: Number of anaesthetics performed at BCH per month by each anaestist")
...
named_anaes_work_tree + labs(title= "Fig 5: Treemap of working relationships")
...
On post operative day 1 there was drinking data available for `r sum(drinking$n)` patients. Overall `r perc_drink` % of patients were drinking on post operative day 1. Figure 8 below demonstrates the number of patients drinking and not drinking on post operative day 1, by month of surgery. (NB there was a change of data collection form in September and October that removed 'drinking' as an individual parameter. As such no data is available for these months. This resulted in all patients being recorded as not drinking)
...
On post operative day 1 there was eating data available for `r sum(eating$n)` patients. Overall `r perc_eat` % of patients were eating on post operative day 1. Figure 9 below demonstrates the number of patients eating and those that were not  on post operative day 1, by month of surgery. (NB there was a change of data collection form in September and October that removed 'eating' as an individual parameter. As such no data is available for these months. This resulted in all patients being recorded as not eating). The colour grey represents where there is missing data. 
...
Drinking, eating and mobilising (DrEaMing) within 24 hours of surgery has been associated with reduced length of stay for certain surgical specialities. `r perc_dream`% of patients were DrEaMing at 24 hours. Figure 11 below demonstrates the number of patients DrEaMing and those that were not on post operative day 1, by month of surgery. (NB as noted above to be 'DrEaMing' a patient must be drinking, eating and mobilising on day 1 post operation. No data is available for drinking and eating for September and October. The result is that no patient, for these 2 months, can be DrEaMing. The LoS for these months did not change. This is a data collection issue rather than a reflection of a change to the established patient pathway.) The colour grey represents where there is missing data.
...
Post operative pain impacts patient recovery and experience. One way to map the changing pain scores through the surgical pathway is using alluvial plots. The chart below demonstrates how the pain experienced by patients changes over time from day 0 through to that at discharge. This chart is populated only with the data of those patients who have pain scores at all 3 time points. 
